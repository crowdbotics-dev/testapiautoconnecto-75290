...
## Project Structure
    ...
    ├── testapiautoconnecto_75290  # Django project configurations
...
1. Clone this repo and `cd testapiautoconnecto_75290`
...
2. Clone this repo and `cd testapiautoconnecto_75290`
